...
1. All content posted on the Services must comply with UK copyright laws. We provide details on [how to file a copyright infringement claim](../copyright/index.md).
...
4. The names, look, and feel of the Services are copyright© to the Company. All rights reserved. You may not duplicate, copy, or reuse any portion of our code, including but not limited to the HTML, CSS, JavaScript, or visual design elements without express written permission from the Company. You must request permission to use the Company's logo or any Service logos for promotional purposes. Please email requests to use logos; we reserve the right to rescind this permission at any time and for any reason.
