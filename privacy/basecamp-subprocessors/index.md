---
title: Zipwire Subprocessors
description: All the third-party subprocessors that we use to run Zipwire.
---

# Zipwire subprocessors

We use third party subprocessors, such as cloud computing providers and customer support software, to run Zipwire (the service). We establish GDPR-compliant data processing agreements with each subprocessor, extending [GDPR safeguards](../regulations/index.md) everywhere personal data is processed.
